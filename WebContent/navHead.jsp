	...
	<header class="bg-dark dk header navbar navbar-fixed-top-xs">
		<div class="navbar-header aside-md" style=" height: 50px;  width: 800px;">
			...
			<a href="#" class="navbar-brand" data-toggle="fullscreen">
				<img src="/BJAdmin/images/logo.png" class="m-r-sm">毕加数据---总部/${branchCompany.companyName}/${branchCompany.area}/${branchCompany.trueName}
			</a> 
							...
							<nav class="nav-primary hidden-xs">
								<ul class="nav">
									...
									<li>
										...
										<ul class="nav lt">
											<li>
												<a href="/BJAdmin/module/customer/inputCustomer.jsp">
													<i class="fa fa-angle-right"></i> 
													<span>客户信息</span>
												</a>
											</li>
											<li>
												<a href="<%=request.getContextPath() %>/module/opponent/inputCompetitor.jsp"> 
													<i class="fa fa-angle-right"></i> 
													<span>竞争对手信息</span>
												</a>
											</li>
											<li>
												<a href="<%=request.getContextPath() %>/module/opponent/getAllOppforMarket"> 
													<i class="fa fa-angle-right"></i> 
													<span>市场信息</span>
												</a>
											</li>
											<li>									   
												<a href="<%=request.getContextPath() %>/module/complain/inputLeaveMessage.jsp"> 
													<i class="fa fa-angle-right"></i> 
													<span>售后服务&投诉</span>
												</a>
											</li>
