...
<body>
	<c:choose>
		...
		<section class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" role="form" method="post" action="showMarket" target="mFrame">
					<div class="form-group">
						<label class="" for="exampleInputEmail2">对手名称</label> <input
							type="text" class="form-control" name="opponentName" id="exampleInputEmail2"
							placeholder="客户信息">
					</div>
    ...
    <iframe src="showMarket" id="mFrame" name="mFrame" class="ifr_page"
