...
<body>
	...
	<form id="one" action="insertCustomer"  class="myform" method="post" > 
	
	<input class="form-control" id="name1" 
			name="customer.id" value="${customer.id}" style="display:none"   />
		...
		<div class="form-group">
			<label>联系电话1</label>
			<input class="form-control"  value="${customer.phone1}" name="customer.phone1" placeholder="请输入联系电话">
		</div>
		<div class="form-group">
			<label>联系电话2</label>
			<input class="form-control"   value="${customer.phone2}"  name="customer.phone2" placeholder="请输入联系电话">
		</div>
		<div class="form-group">
			<label>邮箱</label>
		...
		<div class="form-group">
			<label>级别</label>
			<input class="form-control"  value="${customer.level}" name="customer.level" placeholder="请输入级别:签约/门店/散户">
		</div>
