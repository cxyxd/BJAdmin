	...
	<header class="bg-dark dk header navbar navbar-fixed-top-xs">
		<div class="navbar-header aside-md" style=" height: 50px;  width: 800px;">
			...
			<a href="#" class="navbar-brand" data-toggle="fullscreen">
				<img src="/BJAdmin/images/logo.png" class="m-r-sm">毕加数据--总部
			</a> 
							...
							<nav class="nav-primary hidden-xs">
								<ul class="nav">
									...
									<li>
										...
										<ul class="nav lt">
											<li>
												<a href="<%=request.getContextPath() %>/module/appclient/getAllAppClent?branchId=${branchCompany.companyId}"> 
													<i class="fa fa-angle-right"></i> 
													<span>业务员账号</span>
												</a>
											</li>
											<li>
												<a href="<%=request.getContextPath() %>/module/appclient/getAllBranch">
													<i class="fa fa-angle-right"></i> 
													<span>分区经理账号</span>
												</a>
											</li> 
											...
											<li>
												<a href="<%=request.getContextPath() %>/module/appclient/getCompanyInfo">
													<i class="fa fa-angle-right"></i> 
													<span>总部经理账号</span>
												</a>
											</li>
									...
									<li>
										...
										<ul class="nav lt">
											<li>
										<a href="<%=request.getContextPath() %>/module/version/getHistory">
													<i class="fa fa-angle-right"></i> 
													<span>查看版本信息</span>
												</a>
											</li>
